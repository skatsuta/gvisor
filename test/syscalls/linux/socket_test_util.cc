...
Creator<SocketPair> TCPAcceptBindPersistentListenerSocketPairCreator(
  ...
  auto listener = std::make_shared<std::optional<int>>(std::optional<int>());
  auto addr4 = std::make_shared<std::optional<sockaddr_in>>(
      std::optional<sockaddr_in>());
  auto addr6 = std::make_shared<std::optional<sockaddr_in6>>(
      std::optional<sockaddr_in6>());
